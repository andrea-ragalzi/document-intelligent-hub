...
class TestRepositoryBasicOperations:
    ...
    def test_add_documents(self, test_repository):
    ...
    def test_check_document_exists(self, test_repository):
    ...
    def test_count_document_chunks(self, test_repository):
    ...
    def test_get_user_chunks_sample(self, test_repository):
    ...
    def test_similarity_search(self, test_repository):
    ...
    def test_delete_document(self, test_repository):
    ...
    def test_delete_all_user_documents(self, test_repository):
...
class TestMultiTenancyIsolation:
    ...
    def test_user_isolation_in_similarity_search(self, test_repository):
    ...
    def test_user_isolation_in_chunk_sample(self, test_repository):
    ...
    def test_user_isolation_in_delete(self, test_repository):
...
class TestRepositoryEdgeCases:
    ...
    def test_add_empty_document_list(self, test_repository):
        """Test adding empty list of documents"""
        total_indexed = test_repository.add_documents([])
        assert total_indexed == 0
    
    def test_search_with_no_documents(self, test_repository):
    ...
    def test_delete_nonexistent_document(self, test_repository):
    ...
    def test_large_batch_size(self, test_repository):
    ...
    def test_retriever_factory(self, test_repository):
