...
def mock_firebase_auth():
    ...
    with patch("app.routers.auth_router.auth") as mock_auth:
        ...
        mock_auth.verify_id_token.return_value = {"uid": "test_user_123", "email": "test@example.com"}
...
class TestRegistrationWithInvitationCode:
    ...
    def test_register_with_valid_free_code(self, client: TestClient, mock_firebase_auth, mock_firestore):
        ...
        response = client.post(
            ...
            json={
                "id_token": "mock_token",
                "invitation_code": "VALID_FREE_CODE"
            }
        )
    ...
    def test_register_with_valid_pro_code(self, client: TestClient, mock_firebase_auth, mock_firestore):
        ...
        response = client.post(
            ...
            json={
                "id_token": "mock_token",
                "invitation_code": "VALID_PRO_CODE"
            }
        )
    ...
    @pytest.mark.skip(reason="Requires invitation code to be optional - current implementation requires code")
    def test_register_with_unlimited_email(self, client: TestClient, mock_firebase_auth, mock_firestore):
    ...
    @pytest.mark.skip(reason="Requires invitation code to be optional - current implementation requires code")
    def test_register_without_code_default_free(self, client: TestClient, mock_firebase_auth, mock_firestore):
    ...
    def test_register_with_invalid_code(self, client: TestClient, mock_firebase_auth, mock_firestore):
    ...
    def test_register_with_used_code(self, client: TestClient, mock_firebase_auth, mock_firestore):
    ...
    def test_register_with_expired_code(self, client: TestClient, mock_firebase_auth, mock_firestore):
    ...
    def test_register_missing_token(self, client: TestClient):
        ...
        response = client.post(
            "/auth/register",
            json={
                "invitation_code": "SOME_CODE"
            }
        )
        
        assert response.status_code == 422  # Validation error

    def test_register_invalid_token(self, client: TestClient, mock_firestore):
...
class TestInvitationCodeRequest:
    ...
    def test_request_invitation_code_success(self, client: TestClient, mock_email_service):
    ...
    @pytest.mark.skip(reason="Requires mock email service configuration")
    def test_request_invitation_code_email_failure(self, client: TestClient, mock_email_service):
...
class TestTierLimitsEndpoint:
    ...
    def test_get_tier_limits_success(self, client: TestClient, mock_firestore):
...
class TestUsageEndpoint:
    ...
    def test_get_usage_success(self, client: TestClient, mock_firebase_auth):
    ...
    @pytest.mark.skip(reason="Requires async mock setup for load_app_config")
    def test_get_usage_unlimited_tier(self, client: TestClient, mock_firebase_auth):
