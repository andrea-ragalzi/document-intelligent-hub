...
_document_file_storage: LocalFileStorage | None = None


def get_document_file_storage() -> LocalFileStorage:
    ...
    if _document_file_storage is None:
        _document_file_storage = LocalFileStorage(settings.DOCUMENT_STORAGE_PATH)
