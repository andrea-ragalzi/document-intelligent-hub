...
class AnswerGenerationService:
    ...
    def generate_answer(  # pylint: disable=too-many-arguments
        ...
        *,  # Force keyword-only arguments below
        ...
        logger.debug("Resolved response language: {}", response_language)
    ...
    def _retrieve_and_rerank(
        ...
        *,  # Force keyword-only arguments below
        ...
        logger.debug("RAG timing | query_expansion={:.2f}ms", expansion_ms)
        ...
        logger.debug("Parallel retrieval for {} queries", len(all_queries))
