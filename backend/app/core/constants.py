...
class QueryConstants:
    ...
    MIN_QUERY_LENGTH_FOR_REFORMULATION = 30  # Characters - triggers reformulation if shorter
    ...
    CONVERSATIONAL_PATTERNS = [
        "i mean", "what about", "how about", "what if",
        "invece", "intendo", "voglio dire", "piuttosto",
        "je veux dire", "plutôt", "en fait",
        "ich meine", "stattdessen", "eigentlich"
    ]
...
class LLMConstants:
    ...
    QUERY_GEN_MODEL = "gpt-4o-mini"  # For cheap operations (classification, reformulation)
