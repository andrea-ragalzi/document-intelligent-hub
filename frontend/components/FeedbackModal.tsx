...
export const FeedbackModal: React.FC<FeedbackModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="ui-modal-viewport z-50 bg-black/60" onClick={close}>
      <div className="flex min-h-full items-start justify-center p-3 sm:items-center sm:p-4">
        <div
          className="ui-modal-dialog relative flex w-full max-w-lg flex-col rounded-xl border border-line/20 bg-surface shadow-xl"
